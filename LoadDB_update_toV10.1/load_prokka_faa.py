...
def run_prokka(args): 
    ...
    for directory in os.listdir(args.indir):
        ...
        if 'faa' in files:
            ...
            # for faa file there are no misc rRNA tRNA...
            
                
            with open(files['faa'], "r") as handle:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--outfile",   required=False,  action="store",    dest = "out", default='prokka_faa_data.tsv',
                                                    help="verbose print()")
