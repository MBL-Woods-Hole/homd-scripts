...
#         summer[site] = 0
    ...
    for subjsite in site_subject_summer:
          print('Subject:',subjsite, 'Sum-of-counts(for this subject and site):',site_subject_summer[subjsite])
...
#                                                     help="pnas_counts_per_oligo.csv from pnas: https://www.pnas.org/content/111/28/E2875/tab-figures-data DS:S1")
    ...
    parser.add_argument("-v", "--verbose",   required=False,  action="store_true",    dest = "verbose", default=False,
                                                    help="verbose print()") 
    parser.add_argument("-outfile", "--out_file", required = False, action = 'store', dest = "outfile", default = 'NEW-BLAST_PARSE_RESULT-JMWcuration_wpcts.csv',
                         help = "")
