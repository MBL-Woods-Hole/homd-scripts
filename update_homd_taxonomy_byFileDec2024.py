        ...
        for row in csv_reader:
            ...
            if row['AV Action'] =='Change':
                ...
                for i,rank in enumerate(ranks):   # headers from infile don't match field names
                    ...
                    collector[row['HMT-ID']]['new_taxonomy'][rank] = row['NEW-'+name]
...
#         print()
#         print(otid)
#         print('Old',collector[otid]['old_taxonomy'])
#         print('New',collector[otid]['new_taxonomy'])
    #sys.exit()       
